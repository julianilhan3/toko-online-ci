<nav class="navbar navbar-expand-md bg-pink  fixed-top navbar-dark ">
	<div class="container">
	<img src="<?= base_url(); ?>/assets/images/logo-mhs.png"" alt=""><a class="logo px-2" href="<?= base_url() ?>">Muslimah Home Spa</a>
